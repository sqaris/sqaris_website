...
const HomePageBelow = () => {
  return (
    // Section container for the cards and text
        ...
        <div className="bg-gradient-to-br from-[#100F13] to-[#241a3d] bg-cover" style={{
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
                {cardData.map((card, index) => (
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        className="p-8 rounded-2xl text-center border-purple-400 flex flex-col items-center border justify-center h-64 w-64 "
                        style={{
                    ...
                    >
                        <img src={card.icon} alt={`${card.title} icon`} className="w-16 h-16 mb-4" />

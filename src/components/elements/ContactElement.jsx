...
const MapComponent = () => {
  ...
  const defaultCenter = {
    lat: 10.5276, lng: 76.2144 // Coordinates for Thrissur, Kerala
  };
  ...
  return (
    <LoadScript
      // STEP 2: Replace this with your actual Google Maps API key
      googleMapsApiKey="AIzaSyB5MQdwuxFIG6Msf_At0bV2vPXuFwEkVkI"
    >
      <GoogleMap
    ...
    <div className="font-sans text-white w-full py-20 max-w-6xl mx-auto text-center relative">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 text-left">
        ...
        <div className="lg:col-span-2 flex flex-col justify-start gap-8">
          ...
          {/* UPDATED: Replaced static image with the live map component */}

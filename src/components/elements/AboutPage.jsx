  ...
  return (
    ...
    >
      <div className="flex-col justify-center">
        <h1
          className="text-transparent bg-clip-text bg-gradient-to-br from-[#8C45FF] to-white 
             text-center font-bold text-4xl sm:text-5xl md:text-[72px] leading-tight md:leading-[72px] 
...
function Card({ title, content }) {
  return (
    <div className="relative w-full max-w-[984px] h-auto md:h-[200px] opacity-70 mx-auto">
...
function OurStory() {
  return (
    <div className="relative mx-auto mt-10 px-4 sm:px-8 w-full max-w-[1320px]">
      ...
      <div className="relative w-full rounded-3xl border border-white/10 px-6 sm:px-10 py-8 sm:py-12 overflow-hidden flex flex-col items-center justify-center">
        ...
        <div className="relative flex flex-col gap-6 sm:gap-8 items-center justify-center w-full max-w-5xl">
          ...
          <div className="flex flex-col gap-3 items-center">
            <img src={book} alt="Our Story Icon" className="w-12 h-12 sm:w-16 sm:h-16" />
          ...
          <div className="text-center font-normal font-raleway w-full">
            <p className="text-[#898989] text-base sm:text-lg leading-relaxed sm:leading-[32px] px-2 sm:px-8">
